...
class RestaurantCitiesEdit extends StatefulWidget {
  bool register;
  RestaurantCitiesEdit({this.register});
  @override
  _RestaurantCitiesEditState createState() =>
      _RestaurantCitiesEditState(register);
}

class _RestaurantCitiesEditState extends State<RestaurantCitiesEdit> {
  bool register;
  _RestaurantCitiesEditState(this.register);
  ...
  _listItem(index) {
    return GestureDetector(
      onTap: () {
        ...
        _apiService.updateRestaurant(data).then((value) {
          if (register == true) {
            Navigator.of(context).pushReplacement(MaterialPageRoute(
                builder: (BuildContext context) => ServiceOfferEdit()));
          } else {
